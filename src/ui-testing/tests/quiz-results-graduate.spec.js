...
const RESULTS_FILE = path.join(__dirname, '..', '..', '..', 'results-graduate-test-results.json');
...
for (const quizPath of graduatePaths) {
  test.describe(`Graduate Results — ${quizPath.interest}`, () => {
