...
const groups = [
  ...
  },
  {
    ...
    tests: [
      ...
      { id: 'neg-bad-email', name: 'Submit rejected: Invalid email format', command: 'npx playwright test quiz-negative-scenarios --project=chromium -g "Invalid email format"' },
      { id: 'neg-bad-phone', name: 'Submit rejected: Invalid phone format', command: 'npx playwright test quiz-negative-scenarios --project=chromium -g "Invalid phone format"' },
